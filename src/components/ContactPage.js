        ...
        <div className="left">
          <div id="top">
            <p>Contact Me
              ...
              <a href="tel:+918422058461">+91 8422058461</a>
              <a href="mailto:careemgroup97@gmail.com?subject=Inquiry&body=Hello, I have a question about...">careemgroup97@gmail.com</a>
              <span>address : Shop No.07 akhtari begum complex cementry road <br></br>qureshi nagar kurla east mumbai 400070.</span>
            </p>
          </div>
          ...
          <div id="bottom">
            <form onSubmit={handleSubmit} autoComplete='off'>
              ...
              <textarea id="description" rows={5} cols={5} type="text" name="message" placeholder="Enter Your message here .." minLength={1} maxLength={200} value={formData.message} onChange={handleChange} required />
